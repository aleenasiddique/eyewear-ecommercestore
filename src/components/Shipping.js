...
export default function Shipping(){
    return (
        ...
        <div className="flex flex-col items-center py-8 gap-2  w-[330px] md:w-[430px] border-b md:border-r border-zinc-200 h-[350px] ">
            ...
            <p className="text-xl font-bold mb-4 mt-2">Big Discounts</p>
        ...
        <div className="flex flex-col items-center py-8 gap-2 w-[330px] md:w-[430px] border-b md:border-r border-zinc-200 h-[350px]">
            ...
            <p className="text-xl font-bold mb-4 mt-2">Free Shipping</p>
        ...
        <div className="flex flex-col items-center py-8 gap-2 w-[330px] md:w-[430px]  h-[350px] border-b bordezinc-200">
            <FontAwesomeIcon icon={faCreditCard} className="text-3xl" />
            <p className="text-xl font-bold mb-4 mt-2">Easy Payments</p>
